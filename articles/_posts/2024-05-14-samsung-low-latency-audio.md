...
![Мой Roland MV-8000]({{site.url}}/assets/images/mv8000.jpg)
...
![Oboe api's description]({{site.url}}/assets/images/oboe_apis.png)
...
![DrumThumper application, screen from emulator]({{site.url}}/assets/images/DrumThumper.png)
